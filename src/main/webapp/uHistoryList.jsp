          ...
          <ul id="ull" class="event-list">
              ...
              <li>
                  <time datetime="2014-07-20">
                      <span class="day"><%=dayMap.get(HistoryArray.get(i))%></span>
                      <span class="month"><%=monthMap.get(HistoryArray.get(i))%></span>
                      <span class="year"><%=yearMap.get(HistoryArray.get(i))%></span>
                      <span class="time">ALL DAY</span>
                  </time>
                  <embed src=<%=urlMap.get(HistoryArray.get(i))+"#page=1&toolbar=0&navpanes=0&scrollbar=0"%> type="application/pdf" width=120 height=120>
                  <div class="info">
                      <h2 class="title"><a href=<%=urlMap.get(HistoryArray.get(i))%>><%=HistoryArray.get(i)%></a></h2>
                      <p class="desc"><%=descriptionMap.get(HistoryArray.get(i))%></p>
                  </div>
                  <div class="social">
                      <ul>
                        <!--<li class="facebook" style="width:33%;"><a href="#delete"><span class="fa fa-trash"></span></a></li>-->
                          <li class="facebook" style="width:34%;"><a href=<%=urlMap.get(HistoryArray.get(i))%> download><span class="fa fa-download"></span></a></li>
                      </ul>
                  </div>
              </li>
              <%
