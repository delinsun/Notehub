...
<%
  ...
  title1 = HistoryArray.get(1);
  title2 = HistoryArray.get(2);
  title3 = HistoryArray.get(3);
  title4 = HistoryArray.get(4);
  title5 = HistoryArray.get(5);
  title6 = HistoryArray.get(6);
