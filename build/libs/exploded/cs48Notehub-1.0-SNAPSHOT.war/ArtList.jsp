...
<%
  ...
  title1 = (String) ArtArray.get(1);
  title2 = (String) ArtArray.get(2);
  title3 = (String) ArtArray.get(3);
  title4 = (String) ArtArray.get(4);
  title5 = (String) ArtArray.get(5);
  title6 = (String) ArtArray.get(6);
