...
<%
  ...
  title1 = (String) ArtArray.get(0);
  title2 = (String) ArtArray.get(1);
  title3 = (String) ArtArray.get(2);
  title4 = (String) ArtArray.get(3);
  title5 = (String) ArtArray.get(4);
  title6 = (String) ArtArray.get(5);
        ...
        <div class="[ col-xs-12 col-sm-offset-2 col-sm-8 ]">
          <ul class="event-list">
            <li>
              ...
              <a href=<%="Request?downloadname="+title1+"&downloadtag="+"Art & Music"%>> </a>
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title2+"&downloadtag="+"Art & Music"%>> </a>
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title3+"&downloadtag="+"Art & Music"%>> </a>
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title4+"&downloadtag="+"Art & Music"%>> </a>
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title5+"&downloadtag="+"Art & Music"%>> </a>
              <img alt="Example Picture" src="http://slideplayer.com/6383097/22/images/4/UCSB+CS+Sequence%3A+165A+and+165B.jpg" />
              <div class="info">
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title6+"&downloadtag="+"Art & Music"%>> </a>
              <img alt="Example Picture" src="http://slideplayer.com/6383097/22/images/4/UCSB+CS+Sequence%3A+165A+and+165B.jpg" />
              <div class="info">
