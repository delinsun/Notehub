...
<%
  ...
  title1 = CSArray.get(0);
  title2 = CSArray.get(1);
  title3 = CSArray.get(2);
  title4 = CSArray.get(3);
  title5 = CSArray.get(4);
  title6 = CSArray.get(5);
        ...
        <div class="[ col-xs-12 col-sm-offset-2 col-sm-8 ]">
          <ul class="event-list">
            <li>
              ...
              <a href=<%="Request?downloadname="+title1+"&downloadtag="+"Computer Science"%>> </a>
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title2+"&downloadtag="+"Computer Science"%>> </a>
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title3+"&downloadtag="+"Computer Science"%>> </a>
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title4+"&downloadtag="+"Computer Science"%>> </a>
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title5+"&downloadtag="+"Computer Science"%>> </a>
              <img alt="Example Picture" src="http://slideplayer.com/6383097/22/images/4/UCSB+CS+Sequence%3A+165A+and+165B.jpg" />
              <div class="info">
            ...
            <li>
              ...
              <a href=<%="Request?downloadname="+title6+"&downloadtag="+"Computer Science"%>> </a>
              <img alt="Example Picture" src="http://slideplayer.com/6383097/22/images/4/UCSB+CS+Sequence%3A+165A+and+165B.jpg" />
              <div class="info">
