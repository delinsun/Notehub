...
<%
  ...
  title1 = LitArray.get(0);
  title2 = LitArray.get(1);
  title3 = LitArray.get(2);
  title4 = LitArray.get(3);
  title5 = LitArray.get(4);
  title6 = LitArray.get(5);
  title7 = LitArray.get(6);
                ...
                <div class="[ col-xs-12 col-sm-offset-2 col-sm-8 ]">
                    <ul class="event-list">
                        <li>
                            ...
                            <a href=<%="Request?downloadname="+title1+"&downloadtag="+"Literature"%>> </a>
                        ...
                        <li>
                            ...
                            <a href=<%="Request?downloadname="+title2+"&downloadtag="+"Literature"%>> </a>
                        ...
                        <li>
                            ...
                            <a href=<%="Request?downloadname="+title3+"&downloadtag="+"Literature"%>> </a>
                        ...
                        <li>
                            ...
                            <a href=<%="Request?downloadname="+title4+"&downloadtag="+"Literature"%>> </a>
                        ...
                        <li>
                            ...
                            <a href=<%="Request?downloadname="+title5+"&downloadtag="+"Literature"%>> </a>
                            <img alt="Example Picture" src="http://slideplayer.com/6383097/22/images/4/UCSB+CS+Sequence%3A+165A+and+165B.jpg" />
                            <div class="info">
                        ...
                        <li>
                            ...
                            <a href=<%="Request?downloadname="+title6+"&downloadtag="+"Literature"%>> </a>
                            <img alt="Example Picture" src="http://slideplayer.com/6383097/22/images/4/UCSB+CS+Sequence%3A+165A+and+165B.jpg" />
                            <div class="info">
